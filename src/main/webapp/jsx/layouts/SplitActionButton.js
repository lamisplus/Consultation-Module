    ...
    <React.Fragment>
      <ButtonGroup
        ...
        style={{
          ...
          padding: ".2em 1%",
          width: `${props.actions[0].type === "single" ? "auto" : "150px"}`,
        }}
      >
        <Link
          to={props.actions[0].actions[0].to}
        ...
        >
          <Button
            ...
            onClick={handleClick}
            variant="contained"
            startIcon={props.actions[0].actions[0].icon}
            style={{ backgroundColor: "rgb(153, 46, 98)" }}
          >
            <Typography
              variant="h7"
              style={{ fontWeight: "bolder", whiteSpace: "nowrap" }}
            >
              {props.actions[0].actions[0].name}
            </Typography>
          </Button>
        </Link>
